...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.vm == variableId) {
            setVm((com.ztd.interview_test.mvvm.mainactivity.MainViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setVm(@Nullable com.ztd.interview_test.mvvm.mainactivity.MainViewModel Vm) {
        this.mVm = Vm;
    }
